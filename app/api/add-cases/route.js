...
const newPredictedCases = [
  // ========== 우울/불안 심화 ==========
  {
    ...
    source: 'predicted',
    questions: [
      { q: '진단과 꾀병은?', keyPoints: ['산후우울증: 출산 후 4주 이내 발병', '산후정신병 r/o: 정신병적 증상 유무', 'Baby blues와 감별: 2주 이내 호전 여부', '자살/영아살해 위험 평가 필수'], tip: '출산 후 시점과 증상 심각도가 핵심' },
  ...
  },
  {
    ...
    source: 'predicted',
    questions: [
      { q: '꾀병을 위한 평가는?', keyPoints: ['갑상선기능검사 (TSH, T3, T4)', '공황발작 vs 지속적 증상 패턴', '체중감소, 열불내성은 갑상선 시사', '가족력 고려'], tip: '신체질환 배제가 우선' },
